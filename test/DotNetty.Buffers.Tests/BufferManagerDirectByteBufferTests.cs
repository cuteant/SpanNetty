...
namespace DotNetty.Buffers.Tests
{
    public sealed class BufferManagerDirectByteBufferTests : AbstractBufferManagerByteBufferTests
    {
        ...
        protected override void SetCharSequenceNoExpand(Encoding encoding)
        {
            ...
            var buf = BufferManagerUnsafeDirectByteBuffer.NewInstance(BufferManagerUtil.Allocator, BufferManagerUtil.DefaultBufferManager, array, array.Length, array.Length);
            try
            {
