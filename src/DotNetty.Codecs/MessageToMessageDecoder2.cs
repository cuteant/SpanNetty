...
namespace DotNetty.Codecs
{
    ...
    /// <summary>Message to message decoder.</summary>
    public abstract class MessageToMessageDecoder2<T> : ChannelHandlerAdapter
        where T : class
    {
        ...
        public override void ChannelRead(IChannelHandlerContext context, object message)
        {
            ...
            try
            {
                if (this.TryAcceptInboundMessage(message, out T cast))
                {
                    try
                    {
