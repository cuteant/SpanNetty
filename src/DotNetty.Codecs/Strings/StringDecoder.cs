...
namespace DotNetty.Codecs
{
  ...
  */
  ...
  public class StringDecoder : MessageToMessageDecoder<IByteBuffer>
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="DotNetty.Codecs.StringDecoder" /> class with the current system character set.</summary>
    public StringDecoder()
      : this(Encoding.GetEncoding(0))
    {
    }

    /// <summary>Initializes a new instance of the <see cref="DotNetty.Codecs.StringDecoder" /> class with the specified character set.</summary>
