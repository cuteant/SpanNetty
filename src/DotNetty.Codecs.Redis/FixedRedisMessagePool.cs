...
#else
      this.stringToSimpleStringMessages = new Dictionary<string, SimpleStringRedisMessage>(stringToSimpleStringValues);
...
#else
      this.stringToErrorMessages = new Dictionary<string, ErrorRedisMessage>(errorToErrorValues);
