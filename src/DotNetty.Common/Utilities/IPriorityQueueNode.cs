...
{
    /// <summary>
    /// Provides methods for <see cref="PriorityQueue{T}"/> to maintain internal state. These methods should generally not be
    /// used outside the scope of <see cref="PriorityQueue{T}"/>.
    /// </summary>
        ...
        where T : class, IPriorityQueueNode<T>
    {
        ...
        /// <summary>
        /// Used by <see cref="PriorityQueue{T}"/> to maintain state for an element in the queue.
        /// 
        /// Throwing exceptions from this method will result in undefined behavior.
        /// </summary>
        /// <param name="queue">The queue for which the index is being set.</param>
        /// <param name="i">The index as used by <see cref="PriorityQueue{T}"/>.</param>
