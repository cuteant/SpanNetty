...
namespace DotNetty.Common.Concurrency
{
  ...
  /// <summary> <see cref="IEventExecutor"/> backed by a single thread.</summary>
...
#pragma warning disable 420 // referencing volatile fields is fine in Interlocked methods
    ...
    static readonly IInternalLogger Logger = InternalLoggerFactory.GetInstance<SingleThreadEventExecutor>();
    ...
    /// <summary>Task Scheduler that will post work to this executor's queue.</summary>
