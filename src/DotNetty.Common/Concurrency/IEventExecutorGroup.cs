...
namespace DotNetty.Common.Concurrency
{
  ...
  /// <summary>Provides an access to a set of <see cref="IEventExecutor"/>s it manages.</summary>
  public interface IEventExecutorGroup
  {
    /// <summary>A <see cref="Task"/> for completion of termination. <see cref="ShutdownGracefullyAsync()"/>.</summary>
