...
namespace DotNetty.Common.Concurrency
{
  ...
  /// <summary>Abstract base class for <see cref="IEventExecutor" />s that need to support scheduling.</summary>
  public abstract class AbstractScheduledEventExecutor : AbstractEventExecutor
  {
    ...
    /// <summary>Cancel all scheduled tasks.
    /// This method MUST be called only when <see cref="IEventExecutor.InEventLoop" /> is <c>true</c>.</summary>
