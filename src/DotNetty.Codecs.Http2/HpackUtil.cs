...
namespace DotNetty.Codecs.Http2
{
    ...
    {
        /// <summary>
        /// Compare two <see cref="ICharSequence"/> objects without leaking timing information.
        ...
        internal static int EqualsConstantTime(ICharSequence s1, ICharSequence s2)
        {
            if (s1 is AsciiString s1Ascii && s2 is AsciiString s2Ascii)
            {
                if (s1Ascii.Count != s2Ascii.Count)
                {
                    return 0;
                }

                return PlatformDependent.ByteArrayEqualsConstantTime(s1Ascii.Array, s1Ascii.Offset, s2Ascii.Array, s2Ascii.Offset, s1.Count);
            }
        ...
        internal static readonly int[] HuffmanCodes = {
            0x1ff8,
            0x7fffd8,
            0xfffffe2,
            0xfffffe3,
        ...
        internal static readonly byte[] HuffmanCodeLengths = {
        ...
        internal const int HuffmanEOS = 256;
    }
}
