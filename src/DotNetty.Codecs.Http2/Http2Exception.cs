...
namespace DotNetty.Codecs.Http2
{
    ...
    public class Http2Exception : Exception
    {
        ...
        {
            return new Http2Exception(error, args != null && args.Length > 0 ? string.Format(fmt, args) : fmt);
        }
        ...
        {
            return new Http2Exception(error, args != null && args.Length > 0 ? string.Format(fmt, args) : fmt, cause);
        }
        ...
        {
            return new ClosedStreamCreationException(error, args != null && args.Length > 0 ? string.Format(fmt, args) : fmt);
        }
        ...
        public static Http2Exception StreamError(int id, Http2Error error, string fmt, params object[] args)
        {
            return Http2CodecUtil.ConnectionStreamId == id ?
                    Http2Exception.ConnectionError(error, fmt, args) :
                        new StreamException(id, error, args != null && args.Length > 0 ? string.Format(fmt, args) : fmt);
        }
        ...
        public static Http2Exception StreamError(int id, Http2Error error, Exception cause, string fmt, params object[] args)
        {
            return Http2CodecUtil.ConnectionStreamId == id ?
                    Http2Exception.ConnectionError(error, cause, fmt, args) :
                        new StreamException(id, error, args != null && args.Length > 0 ? string.Format(fmt, args) : fmt, cause);
        }
        ...
        public static Http2Exception HeaderListSizeError(int id, Http2Error error, bool onDecode, string fmt, params object[] args)
        {
            return Http2CodecUtil.ConnectionStreamId == id ?
                    Http2Exception.ConnectionError(error, fmt, args) :
                        new HeaderListSizeException(id, error, args != null && args.Length > 0 ? string.Format(fmt, args) : fmt, onDecode);
        }
