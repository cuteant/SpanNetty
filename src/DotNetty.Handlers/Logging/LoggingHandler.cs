...
namespace DotNetty.Handlers.Logging
{
  ...
  public class LoggingHandler : ChannelHandlerAdapter
  {
    ...
    /// <summary>Creates a new instance whose logger name is the fully qualified class name of the instance.</summary>
    ...
    /// <summary>Creates a new instance with the specified logger name and with hex dump enabled.</summary>
    ...
    /// <summary>Returns the <see cref="LogLevel" /> that this handler uses to log.</summary>
    ...
    /// <summary>Formats an event and returns the formatted message.  This method is currently only used for formatting
    /// <see cref="IChannelHandler.ConnectAsync(IChannelHandlerContext, EndPoint, EndPoint)" />.</summary>
    /// <param name="eventName">the name of the event</param>
    ...
    /// <summary>Generates the default log message of the specified event whose argument is an arbitrary object.</summary>
