    ...
    internal static partial class NativeMethods
    {
        ...
        internal static HandleContext Initialize(IntPtr loopHandle, uv_handle_type handleType, ScheduleHandle target, object[] args)
        {
            ...
            switch (handleType)
            {
                ...
                default:
                    throw ThrowHelper.GetNotSupportedException_Handle_type_to_initialize_not_supported(handleType);
            }
        }
        ...
        internal static void Start(uv_handle_type handleType, IntPtr handle)
        {
            ...
            switch (handleType)
            {
                ...
                case uv_handle_type.UV_IDLE:
                    ...
                    break;
                default:
                    throw ThrowHelper.GetNotSupportedException_Handle_type_to_start_not_supported(handleType);
            }
            ThrowIfError(result);
        }
        ...
        internal static void GetSocketAddress(IPEndPoint endPoint, out sockaddr addr)
        {
            ...
            switch (endPoint.AddressFamily)
            {
                ...
                case AddressFamily.InterNetworkV6:
                    ...
                    break;
                default:
                    throw ThrowHelper.GetNotSupportedException_expecting_InterNetworkkV6OrV4(endPoint);
            }
            ThrowIfError(result);
        }
