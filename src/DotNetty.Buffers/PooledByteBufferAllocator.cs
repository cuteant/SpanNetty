...
namespace DotNetty.Buffers
{
  ...
  public class PooledByteBufferAllocator : AbstractByteBufferAllocator
  {
    ...
    public PooledByteBufferAllocator(int heapArenaCount, int pageSize, int maxOrder)
      : this(heapArenaCount, pageSize, maxOrder, DEFAULT_TINY_CACHE_SIZE, DEFAULT_SMALL_CACHE_SIZE, DEFAULT_NORMAL_CACHE_SIZE)
    {
    }
...
#else
    public IList<IPoolArenaMetric> HeapArenas() => this.heapArenaMetrics;
#endif
