...
| Stage                               | Status                                                                                                                                                                                                                                                            	|
|-------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
| Build                               | [![Build Status](https://dev.azure.com/SpanNetty/SpanNetty/_apis/build/status/SpanNetty/pr-validation?branchName=release%2F0.7.x&jobName=Windows%20Build)](https://dev.azure.com/SpanNetty/SpanNetty/_build/latest?definitionId=2&branchName=release%2F0.7.x)	|
| .NET Framework Unit Tests           | [![Build Status](https://dev.azure.com/SpanNetty/SpanNetty/_apis/build/status/SpanNetty/pr-validation?branchName=release%2F0.7.x&jobName=.NET%20Framework%20Unit%20Tests%20(Windows))](https://dev.azure.com/SpanNetty/SpanNetty/_build/latest?definitionId=2&branchName=release%2F0.7.x) |
| .NET Core (Windows) Unit Tests      | [![Build Status](https://dev.azure.com/SpanNetty/SpanNetty/_apis/build/status/SpanNetty/pr-validation?branchName=release%2F0.7.x&jobName=.NET%20Core%20Unit%20Tests%20(Windows))](https://dev.azure.com/SpanNetty/SpanNetty/_build/latest?definitionId=2&branchName=release%2F0.7.x) |
| .NET Core (Linux) Unit Tests        | [![Build Status](https://dev.azure.com/SpanNetty/SpanNetty/_apis/build/status/SpanNetty/pr-validation?branchName=release%2F0.7.x&jobName=.NET%20Core%20Unit%20Tests%20(Linux))](https://dev.azure.com/SpanNetty/SpanNetty/_build/latest?definitionId=2&branchName=release%2F0.7.x) |
